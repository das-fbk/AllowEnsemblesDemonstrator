...
public class Preferences {
    ...
    public Preferences(double ttw, double cw, double wdw, double ncw,
	    double rcw, double uspw, double wsdw, long tmax, double cmax,
	    double wmax, int nocmax, double namesens, double emailsens,
	    double phonesens, double gpssens, boolean unsafear,
	    boolean crowdedar, boolean pollutedar, boolean untrustedprov) {
	ttweight = ttw;
	cweight = cw;
	wdweight = wdw;
	ncweight = ncw;

...
/**
 * The base implementation for animations. All default values apply
 * (duration=200ms, startOffset=0ms, interpolator=LinearInterpolator). <br>
 * <br>
 * Use this class to write your own animation. The animate() method has to be
 * implemented to change the target component. If an initial value is necessary,
 * feel free to override the prepare() method.
 */
public abstract class AbstractAnimation implements Animation {
	...
	if (getInterpolator() != null) {
	    animationProgress = getInterpolator().interpolate(
		    animationProgress, getDuration());
	}
    ...
    /**
     * Fires the animation update event to all registered listeners
     */
